        ...
        <div className="about-inner">
            ...
            <div className="about-timeline">
                ...
                <div className="about-timeline__card">
                    ...
                    <span className="about-timeline__period">
                        2022.12 – 2025.02
                    </span>
                    </div>
                ...
                <div className="about-timeline__card">
                    <div className="about-timeline__header">
                    <h3 className="about-timeline__title">BGF 경영진단팀</h3>
                    <span className="about-timeline__period">
                        2018.02 – 2022.11
                    </span>
                    </div>
                    <p className="about-timeline__role">
                    윤리경영 커뮤니케이션 및 내부 감사 지원
                    </p>
                    <p className="about-timeline__desc">
                    윤리경영 콘텐츠 기획 및 캠페인 실행, 윤리레터 기획·발송,
                    금품 등 수수 신고 물품 사내 경매 및 수익금 기부 진행,
                    그룹웨어 게시판 관리와 내부 신고제도 운영 등 윤리경영
                    커뮤니케이션 전반을 담당했습니다.
                    </p>
                </div>
                </div>
            ...
            <section className="about-section__card">
                ...
                <li className="about-list__item">
                    윤리경영·내부 커뮤니케이션을 위한 뉴스레터, 캠페인 콘텐츠
                    기획 및 디자인
                </li>
                <li className="about-list__item">
                    B2B 영업 리플렛, 제안서용 시각 자료, 상품·서비스 홍보물 등
                    마케팅 자료 제작
                </li>
                <li className="about-list__item">
                    윤리경영 관련 메시지를 이해하기 쉬운 문구와 시각 요소로 풀어내
                    임직원에게 전달
                </li>
                <li className="about-list__item">
                    목적과 타깃에 맞는 커뮤니케이션 자료를 기획하고 제작
                </li>
                </ul>
            </section>

            <section className="about-section__card">
                <h2 className="about-section__title">Tools &amp; Skills</h2>
                <ul className="about-tags">
                <li className="about-tag">Adobe Photoshop</li>
                <li className="about-tag">Adobe Illustrator</li>
                <li className="about-tag">Microsoft PowerPoint</li>
                <li className="about-tag">HTML · CSS</li>
                </ul>

                <h2 className="about-section__title about-section__title-sub">
                Currently Learning
                </h2>
                <ul className="about-tags">
                <li className="about-tag">JavaScript</li>
                <li className="about-tag">React</li>
                <li className="about-tag">Java</li>
                </ul>
            </section>
            </div>
        </div>
