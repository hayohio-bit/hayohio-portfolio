...
const getRawProjects = () => {
  return (portfolioData.portfolios || []).map((p) => ({
    ...p,
...
export const getAllProjects = () => {
  return getRawProjects().filter((p) => p.status === "published" && !p.isReference);
};
...
export const getProjectById = (id) => {
  ...
  return {
    ...
    thumbnail:
      project.thumbnail ||
      project.images[0] ||
      fixPath("/assets/images/default-placeholder.jpg"),
  };
};
